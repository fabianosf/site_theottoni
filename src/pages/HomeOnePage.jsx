...
import { galeriaItems as galeriaSrc } from "../config/assetsConfig.js";
import { assets } from "../config/assetsConfig.js";
import { globalIntro, windAndCampus } from "../content/verbatim.js";
...
export default function HomeOnePage() {
  ...
  const windImgAlt = dict[L].portfolio.items[0].alt;
    ...
    <>
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <p className="text-[10px] font-semibold uppercase tracking-[0.3em] text-amber-600 dark:text-amber-500 sm:text-xs sm:tracking-[0.35em]">{t("brand.name")}</p>
      ...
      <Galeria
        items={[
          { src: galeriaSrc[0].src, alt: t("gallery.altPredio") },
          { src: galeriaSrc[1].src, alt: t("gallery.altEolica") },
        ]}
      />
      <Portfolio />
      <ContactForm />
